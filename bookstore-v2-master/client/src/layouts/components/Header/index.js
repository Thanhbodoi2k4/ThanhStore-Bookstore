      ...
      <div className={styles.headerCenter}>
          <Container>
            <div className={styles.headerRow}>
              <NavBarMobile />
              <Link to='/' ><h1 className={`${styles.bookstoreHighlight} me-5`}>ThanhStore</h1></Link>
                ...
                <div className={styles.headerIcon}>
                  {
                    ...
                    <div className={styles.account}>
                      ...
                      <div className={styles.accountPopup}>
                          ...
                          {currentUser.role > 0 && (
                            <>
                              <div className={styles.item}><Link className={styles.popupLink} to="/admin">Quản lý ThanhStore</Link></div>
                            </>
                          )}
