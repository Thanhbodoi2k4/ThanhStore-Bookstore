...
const verifyToken = (req, res, next) => {
    ...
    jwt.verify(token, process.env.JWT_ACCESS_TOKEN_SECRET, async (err, data) => {
        ...
        // Dòng Fix lỗi chuyên nghiệp: Ép biến role về chuẩn Số (Number)
        req.user = {userId: userId, role: Number(role) || 0}
        
        // In ra Terminal để có bằng chứng fix bug làm báo cáo
        console.log(">> CHECK TOKEN - UserId:", userId, " | Role:", req.user.role);
